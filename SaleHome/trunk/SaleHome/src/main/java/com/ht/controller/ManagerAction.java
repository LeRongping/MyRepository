...
public class ManagerAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
	...
	private String id;
	private String fastuseraccount;
	public String getId() {
		return id;
	}
	...
	public String getFastuseraccount() {
		return fastuseraccount;
	}

	public void setFastuseraccount(String fastuseraccount) {
		this.fastuseraccount = fastuseraccount;
	}
...
// 			if(result>0){
// 				System.out.println("管理员"+manageraccount+"成功接收"+result+"条短信");
// 			}else{
// 				System.out.println(client.getErrorMsg(result));
// 			}
		} catch (Exception e) {
